...
export class LayoutComponent {
  ...
  // Sanitizes and returns the SVG string for safe rendering
  private getIcon(name: string) {
    const svg = this.icons[name];
    // Security: Sanitize the SVG content before rendering it.
    return this.sanitizer.bypassSecurityTrustHtml(svg);
  }

  // A map of icon names to their SVG content
